...
'''
def test_equalness(mat1, mat2, eps = 1e-6):
...
def construct_random_np(nrow, ncol):
...
def test_mulby_naive():
    for _ in range(500):
        npm1 = construct_random_np(50, 50)
        npm2 = construct_random_np(50, 50)
        m1 = np_to_mat(npm1)
        m2 = np_to_mat(npm2)
        m3 = _matrix.multiply_naive(m1, m2)
        m_golden = np_to_mat(np.matmul(npm1, npm2))
        assert test_equalness(m3, m_golden)
...
def test_performance():
    npm1 = construct_random_np(1000, 1000)
    npm2 = construct_random_np(1000, 1000)
    m1 = np_to_mat(npm1)
    m2 = np_to_mat(npm2)
    ...
    assert test_equalness(m_golden, m_naive)
    assert test_equalness(m_golden, m_tile16)
    #assert test_equalness(m_golden, m_tile256)
    assert test_equalness(m_golden, m_mkl)
