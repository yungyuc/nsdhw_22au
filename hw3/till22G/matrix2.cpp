...
class Matrix
{
    friend Matrix multiply_naive(Matrix const& m1, Matrix const& m2);
    friend Matrix multiply_tile(Matrix const& m1, Matrix const& m2, size_t const tsize);
    friend Matrix multiply_mkl(Matrix const& m1, Matrix const& m2);
...
const Matrix multiply_tile(Matrix const& m1, Matrix const& m2) {
