...
public:
    ...
    // operator
    //--------------------------------------------------- array_t structure from source code
    /*
    array_t(ShapeContainer shape,
            StridesContainer strides,
            const T *ptr = nullptr,
            handle base = handle())
        : array(std::move(shape), std:
    */
    //---------------------------------------------------
    ...
    py::array_t<double> array() 
    {
		return py::array_t<double>(
                {nrow(), ncol()}, // ShapeContainer shape,
                {sizeof(double) * ncol(), sizeof(double)}, // StridesContainer strides,
                m_buffer, // const T *ptr = nullptr,
                py::cast(this) // handle base = handle()
                );
    }
