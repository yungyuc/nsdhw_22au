...
class MatrixTest(unittest.TestCase):
    ...
    def testEqual(self):
        self.l_m_copy = _matrix.Matrix(self.l_m)
        self.assertTrue(self.l_m == self.l_m_copy)
    
    def testNotEqual(self):
        self.assertTrue(self.l_m != self.r_m)
        l_m_copy = _matrix.Matrix(self.l_m)
        l_m_copy[99, 799] = -1
        self.assertTrue(self.l_m != l_m_copy)
    ...
    def testArray(self):
        self.assertIsInstance(self.l_m.array, numpy.ndarray)
